...
export default function NotFound() {
  return (
    <section>
      <SectionHeader
        kicker="Error 404 — Halaman Tidak Ditemukan"
        title="Entri ini tidak ada di buku besar"
      />
      <div className="panel ledger-grid p-8 md:p-12">
        ...
        <p className="mt-6 max-w-lg text-sm leading-relaxed text-muted-foreground">
          Alamat yang Anda buka tidak terdaftar pada aplikasi ini. Periksa kembali tautannya, atau
          kembali ke dashboard untuk melanjutkan pencatatan.
        </p>
